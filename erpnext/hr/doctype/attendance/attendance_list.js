frappe.listview_settings['Attendance'] = {
    ...
    list_view.page.add_inner_button(__("Import Lark Attendance"), async function () {
      await Promise.all([
        frappe.model.with_doctype('Salary Structure Assignment Company', function(){}, true),
        frappe.model.with_doctype('Salary Structure Assignment Branch', function(){}, true),
      ...
      var d = new frappe.ui.Dialog({
        ...
        fields: [
          ...
          { fieldname: "company", fieldtype: "Table MultiSelect", options: "Salary Structure Assignment Company", label: __("Company") },
          { fieldname: "branch", fieldtype: "Table MultiSelect", options: "Salary Structure Assignment Branch", label: __("Branch") },
